...
class WordList
	...
	def self.search(seed)
		...
		apikey_str = File.read('lib/secrets.json')
	...
	def self.make_neat_arrays(words)
		...
		nouns = self.remove_results_with_spaces(nouns)
	...
	# this function throws out any two word synonyms which also gets rid of antonyms because they are formatted |word (antonym)|
	def self.remove_results_with_spaces(array)
		temp = []
